...
export default function LoginPage() {
  ...
  // Already authenticated — redirect handled by chat page guard
  if (user) {
    router.replace('/chat');
    return null;
  }
    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex w-[440px] flex-shrink-0 flex-col bg-[#09090B] relative overflow-hidden p-10">
        ...
        <div className="relative flex items-center gap-2.5 mb-auto">
          <KaiLogo size={32} />
          <div>
            <div className="text-white" style={{ fontSize: '15px', fontWeight: 600 }}>K-AI</div>
        ...
        <div className="relative">
          <blockquote className="text-white/80 mb-4 leading-relaxed" style={{ fontSize: '15px' }}>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[380px]">
          ...
          <div className="flex lg:hidden items-center gap-2 mb-8">
            <KaiLogo size={28} />
            <div>
              <div className="text-gray-900" style={{ fontSize: '15px', fontWeight: 600 }}>K-AI</div>
          ...
          {mode === 'confirm' ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                >
                  {busy ? <><Spinner /> Confirming…</> : <>Confirm account <ArrowRight className="w-4 h-4" /></>}
                </button>
              </form>
            ...
            <>
              ...
              <button
                type="button"
                disabled
                className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl border border-gray-200 bg-white text-gray-400 cursor-not-allowed mb-4 opacity-50"
                style={{ fontSize: '14px' }}
              >
              ...
              <button
                type="button"
                disabled
                className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl border border-gray-200 bg-white text-gray-400 cursor-not-allowed mb-6 opacity-50"
                style={{ fontSize: '14px' }}
              >
                <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
